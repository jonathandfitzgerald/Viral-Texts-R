...
tidiedLessUnknown = tidied %>% filter(primary_genre=="Unknown") %>% filter(classified_genre!="Unknown") %>% filter(probability > .1) 
...
write.csv(genreClass, file = paste('output/genreClass-all-genres-point1-threshhold.csv',sep=""))
